...
payload = {
    "message": "Please list out the annual-fee (float), avg-apr (float), card-type (str) (Visa, Mastercard, etc.), company-name, description (str, 2 sentences), foreign-fee (float), create id that is str, intro-offer (bool), intro-offer-details (str), max-cashback (float), min-cashback (float), name (str, name of card), and finally overcharge-fee (float). Only list out one card list in JSON format. If you don't have data just put 'N/A'.",
    # documents has title of document and snippet of text
    "documents": [
        {"title": "Card Terms and Conditions", "snippet": snippet_data},
    ],
